...
public class PersonMapper {
  ...
  public Person mapToDatabasePerson(pl.zzpj.core.domain.model.userModel.Person person) {
  ...
  public pl.zzpj.core.domain.model.userModel.Person mapToDomainModelPerson(Person person) {
    var address = addressMapper.mapToDomainModelAddress(person.getAddress());

    return pl.zzpj.core.domain.model.userModel.Person.builder(person.getFirstName(),
