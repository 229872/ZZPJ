...
public interface VehicleTireCommandPort { //todo exceptions?
    ...
    VehicleTire add(VehicleTire tire) throws VehicleEquipmentServiceCreateException;

    VehicleTire update(VehicleTire tire) throws VehicleEquipmentServiceNotFoundException, VehicleEquipmentServiceUpdateException;
